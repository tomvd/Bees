...
public class Workgiver_SplitBeehive : WorkGiver_Scanner
{
    ...
    public override bool HasJobOnThing(Pawn pawn, Thing t, bool forced = false)
    {
        ...
        if (beehive == null || !beehive.MarkedForSplitting || skill < 5)
        {
            return false;
        }
        if (t.IsBurning())
    ...
    {
        return new Job(InternalDefOf.Bees_SplitBeehive, t);
    }
}